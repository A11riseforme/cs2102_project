...
Backup Time: 2019-11-12 02:05:22
*/
...
DROP FUNCTION IF EXISTS "public"."clash_with_lecture()";
DROP FUNCTION IF EXISTS "public"."clash_with_tutorial()";
...
CREATE OR REPLACE FUNCTION "clash_with_lecture"()
  RETURNS "pg_catalog"."trigger" AS $BODY$
DECLARE
day integer;
...
BEGIN
  ...
  WITH all_class AS (
    SELECT module_code, rid, session FROM Bid Bi WHERE Bi.uname = NEW.uname AND is_successful = TRUE
  ), all_time As (
  ...
  IF has_clash
  THEN RAISE EXCEPTION 'module % clash with another lecture at time from % to %', NEW.module_code, start_time, end_time;
  ELSE RETURN NEW;
  END IF;
END;
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION "clash_with_lecture"() OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "clash_with_tutorial"()
  RETURNS "pg_catalog"."trigger" AS $BODY$
DECLARE
day integer;
start_time varchar(30);
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION "clash_with_tutorial"() OWNER TO "postgres";
...
INSERT INTO "public"."bid" ("uname","bid","module_code","rid","session","is_successful") VALUES ('user', 120, 'cs2106', 1, 2, 'f'),('test', 130, 'cs2106', 1, 2, 'f'),('teste', 140, 'cs2106', 1, 2, 'f'),('testeee', 160, 'cs2106', 1, 2, 'f'),('user', 200, 'cs1111', 1, 2, 'f'),('test', 190, 'cs1111', 1, 2, 'f'),('teste', 180, 'cs1111', 1, 2, 'f'),('testee', 180, 'cs1111', 1, 2, 'f'),('testeee', 180, 'cs1111', 1, 2, 'f'),('testeeee', 170, 'cs1111', 1, 2, 'f'),('testee', 150, 'cs2106', 1, 2, 'f'),('testeeee', 170, 'cs2106', 1, 2, 'f');
COMMIT;
BEGIN;
...
INSERT INTO "public"."class" ("module_code","rid","session","quota","week_day","s_time","e_time") VALUES ('cs2102', 1, 1, 50, 1, '08:00:00', '10:00:00'),('cs4000', 1, 1, 100, 7, '08:00:00', '10:00:00'),('cs2102', 2, 2, 100, 5, '14:00:00', '16:00:00'),('cs1231', 2, 1, 70, 5, '14:00:00', '16:00:00'),('cs1010', 2, 1, 1, 7, '08:00:00', '10:00:00'),('cs3000', 2, 1, 100, 7, '08:00:00', '10:00:00'),('cs4000', 2, 1, 100, 7, '01:01:01', '10:10:10'),('cs4000', 1, 2, 50, 1, '09:00:00', '11:00:00'),('cs2102', 3, 1, 50, 2, '14:00:00', '15:00:00'),('cs2102', 3, 2, 40, 2, '15:00:00', '16:00:00'),('cs4000', 3, 1, 20, 3, '10:00:00', '11:00:00'),('cs1111', 1, 1, 90, 1, '18:00:00', '21:00:00'),('cs3000', 2, 2, 100, 7, '12:00:00', '14:00:00'),('cs3000', 2, 3, 30, 7, '13:00:00', '15:00:00'),('cs1111', 2, 1, 40, 1, '12:00:00', '14:00:00'),('cs1111', 2, 3, 40, 1, '09:00:00', '11:00:00'),('cs1111', 2, 4, 50, 1, '11:00:00', '13:00:00'),('cs2102', 3, 3, 20, 7, '09:00:00', '10:00:00'),('cs4000', 3, 2, 50, 2, '14:00:00', '16:00:00'),('cs2106', 1, 1, 100, 1, '09:00:00', '11:00:00'),('cs3235', 1, 1, 100, 3, '16:00:00', '18:00:00'),('EE3123', 1, 1, 200, 5, '16:00:00', '18:00:00'),('cs1111', 1, 2, 4, 1, '19:00:00', '22:00:00'),('cs2106', 1, 2, 5, 2, '14:00:00', '16:00:00');
COMMIT;
BEGIN;
...
INSERT INTO "public"."rounds" ("rid","admin","s_date","e_date") VALUES (3, 'admin', '2020-11-16 09:00:00', '2020-11-20 11:59:59'),(2, 'admin', '2020-11-13 08:00:00', '2020-11-15 11:59:59'),(1, 'admin', '2019-11-04 08:00:00', '2019-11-11 11:59:59');
COMMIT;
BEGIN;
LOCK TABLE "public"."student" IN SHARE MODE;
DELETE FROM "public"."student";
INSERT INTO "public"."student" ("uname","matric_no","bid_point","authcode") VALUES ('user', 'A100', 680, 'OROREIHHMJ'),('test', 'A101', 680, NULL),('teste', 'A102', 680, NULL),('testee', 'A103', 670, NULL),('testeee', 'A104', 660, NULL),('testeeee', 'A105', 660, NULL);
COMMIT;
BEGIN;
LOCK TABLE "public"."studentinfo" IN SHARE MODE;
DELETE FROM "public"."studentinfo";
INSERT INTO "public"."studentinfo" ("matric_no","cap","fname","rname","nusnetid") VALUES ('A101', 2.00, 'FOE', 'Ye Guoquan', 'e0324531'),('A102', 0.00, 'FASS', 'Huang Xuankun', 'e0319118'),('A103', 4.00, 'SOC', 'Wei Feng', 'e0319031'),('A100', 4.00, 'SOC', 'Lebron James', 'e1111111'),('A104', 4.00, 'SOC', 'Yang Chenglong', 'e0175540'),('A105', 4.50, 'FASS', 'Michael Jordan', 'e1900000');
COMMIT;
BEGIN;
...
INSERT INTO "public"."users" ("uname","password") VALUES ('admin', 'password1'),('user', 'password'),('test', 'password'),('teste', 'password'),('testee', 'password'),('testeee', 'password'),('testeeee', 'password');
COMMIT;
...
FOR EACH ROW
EXECUTE PROCEDURE "public"."clash_with_tutorial"();
CREATE TRIGGER "tutorial_clash_with_lecture" BEFORE INSERT ON "ballot"
FOR EACH ROW
EXECUTE PROCEDURE "public"."clash_with_lecture"();
