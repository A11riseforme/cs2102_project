...
Backup Time: 2019-11-12 08:31:03
*/
...
INSERT INTO "public"."ballot" ("uname","rank","module_code","rid","session","is_successful") VALUES ('user', 1, 'cs1231', 3, 1, 't'),('testee', 1, 'cs1231', 3, 1, 't'),('user', 2, 'cs2102', 3, 2, 't'),('testee', 1, 'cs2106', 3, 1, 't');
COMMIT;
BEGIN;
LOCK TABLE "public"."bid" IN SHARE MODE;
DELETE FROM "public"."bid";
INSERT INTO "public"."bid" ("uname","bid","module_code","rid","session","is_successful") VALUES ('user', 150, 'cs4000', 1, 1, 't'),('user', 100, 'cs2102', 1, 1, 't'),('testee', 1, 'cs4000', 1, 1, 't'),('user', 1, 'cs1231', 1, 1, 't'),('testee', 1, 'cs1231', 1, 1, 't'),('user', 1, 'cs2106', 1, 4, 't'),('testee', 1, 'cs2106', 1, 4, 't');
COMMIT;
BEGIN;
...
INSERT INTO "public"."class" ("module_code","rid","session","quota","week_day","s_time","e_time") VALUES ('cs2102', 1, 1, 50, 1, '08:00:00', '10:00:00'),('cs4000', 1, 1, 100, 7, '08:00:00', '10:00:00'),('cs2102', 2, 2, 100, 5, '14:00:00', '16:00:00'),('cs1010', 2, 1, 1, 7, '08:00:00', '10:00:00'),('cs3000', 2, 1, 100, 7, '08:00:00', '10:00:00'),('cs4000', 2, 1, 100, 7, '01:01:01', '10:10:10'),('cs4000', 1, 2, 50, 1, '09:00:00', '11:00:00'),('cs2102', 3, 1, 50, 2, '14:00:00', '15:00:00'),('cs1111', 1, 1, 90, 1, '18:00:00', '21:00:00'),('cs3000', 2, 2, 100, 7, '12:00:00', '14:00:00'),('cs3000', 2, 3, 30, 7, '13:00:00', '15:00:00'),('cs1111', 2, 1, 40, 1, '12:00:00', '14:00:00'),('cs1111', 2, 3, 40, 1, '09:00:00', '11:00:00'),('cs2102', 3, 3, 20, 7, '09:00:00', '10:00:00'),('cs3235', 2, 1, 100, 3, '16:00:00', '18:00:00'),('cs1111', 3, 1, 20, 4, '14:00:00', '15:00:00'),('cs4000', 3, 1, 20, 1, '09:00:00', '10:00:00'),('cs3235', 3, 1, 1, 1, '19:00:00', '20:00:00'),('cs1111', 1, 2, 1, 1, '19:00:00', '22:00:00'),('cs1111', 3, 2, 1, 4, '10:00:00', '11:00:00'),('cs4000', 3, 2, 1, 2, '14:00:00', '16:00:00'),('cs2102', 3, 2, 23, 2, '14:00:00', '15:00:00'),('cs1231', 3, 1, 50, 3, '15:00:00', '16:00:00'),('cs1231', 1, 1, 70, 5, '14:00:00', '16:00:00'),('cs2106', 1, 4, 1, 1, '11:00:00', '13:00:00'),('cs2106', 3, 1, 50, 2, '15:00:00', '16:00:00');
COMMIT;
BEGIN;
...
INSERT INTO "public"."rounds" ("rid","admin","s_date","e_date") VALUES (2, 'admin', '2019-11-09 08:00:00', '2019-11-10 11:59:59'),(1, 'admin', '2019-11-04 08:00:00', '2019-11-07 11:59:00'),(3, 'admin', '2019-11-11 09:00:00', '2019-11-11 11:59:59');
COMMIT;
BEGIN;
LOCK TABLE "public"."student" IN SHARE MODE;
DELETE FROM "public"."student";
INSERT INTO "public"."student" ("uname","matric_no","bid_point","authcode") VALUES ('user', 'A100', 748, 'OROREIHHMJ'),('testee', 'A104', 997, 'YBMERCUJBS');
COMMIT;
BEGIN;
...
INSERT INTO "public"."users" ("uname","password") VALUES ('admin', 'password1'),('user', 'password'),('testee', 'password123');
COMMIT;
