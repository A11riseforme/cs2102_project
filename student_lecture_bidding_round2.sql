...
Backup Time: 2019-11-11 23:48:49
*/
...
INSERT INTO "public"."bid" ("uname","bid","module_code","rid","session","is_successful") VALUES ('user', 150, 'cs4000', 1, 1, 't'),('user', 100, 'cs2102', 1, 1, 't');
COMMIT;
BEGIN;
...
INSERT INTO "public"."rounds" ("rid","admin","s_date","e_date") VALUES (1, 'admin', '2019-11-04 08:00:00', '2019-11-08 11:59:59'),(2, 'admin', '2019-11-09 08:00:00', '2020-11-15 11:59:59'),(3, 'admin', '2020-11-16 09:00:00', '2020-11-20 11:59:59');
COMMIT;
BEGIN;
LOCK TABLE "public"."student" IN SHARE MODE;
DELETE FROM "public"."student";
INSERT INTO "public"."student" ("uname","matric_no","bid_point","authcode") VALUES ('testee', 'A104', 1000, 'YBMERCUJBS'),('user', 'A100', 750, 'OROREIHHMJ');
COMMIT;
BEGIN;
